    ...
    <div className="bg-[url('/images/hero/dotbg2.png')] bg-cover bg-center px-2 md:px-0 " id="contact-us">
      ...
      <div className="container mx-auto">
        <div className="relative h-[750px] md:h-[700px] rounded-2xl md:-translate-y-[140px] ">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-white/50 to-transparent rounded-2xl ">
            <form className="w-full md:w-1/2 flex flex-col justify-center h-full px-4 md:px-20 gap-3" ref={form2} onSubmit={sendEmail2} >
